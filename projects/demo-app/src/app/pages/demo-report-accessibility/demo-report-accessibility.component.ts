...
@Component({
	selector: 'app-demo-report-accessibility',
	templateUrl: './demo-report-accessibility.component.html',
	styleUrls: ['./demo-report-accessibility.component.scss'],
})
export class DemoReportAccessibilityComponent implements OnInit {
	...
	navigateToReportPreview(option: string | null = null, alertCode: string | null = null) {
		this._router
			.navigate([`/accessibility/${option ?? 'both'}`], {
				queryParams: {
					alertCode: alertCode,
