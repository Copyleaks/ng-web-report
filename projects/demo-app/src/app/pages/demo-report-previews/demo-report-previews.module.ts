...
import { CopyleaksWebReportActionsModule } from 'projects/copyleaks-web-report/src/lib/components/core/copyleaks-web-report-actions/copyleaks-web-report-actions.module';
...
@NgModule({
  ...
  imports: [
    ...
    CopyleaksWebReportActionsModule,
  ],
